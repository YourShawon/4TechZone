...
const SocialToggle = () => {
  return (
    <div className="relative">
      <div className="fixed justify-end group -right-4 hover:right-8 md:right-8 bottom-14 md:bottom-15 z-40">
        <div className="hidden group-hover:block transition-all duration-500">
          <Link
            href="#"
            target="_blank"
            className="absolute p-1 bg-[#d9edf9] rounded-full -top-5 left-3 z-50"
          >
          ...
          <Link
            href="#"
            target="_blank"
            className="absolute p-1 bg-[#d9edf9] rounded-full -top-5 right-4 z-50"
          >
          ...
          <Link
            href="#"
            target="_blank"
            className="absolute p-1 bg-[#d9edf9] rounded-full top-14 -left-8 z-50"
          >
          ...
          <Link
            href="#"
            target="_blank"
            className="absolute p-1 bg-[#d9edf9] rounded-full top-14 -right-8 z-50"
          >
            {" "}
          ...
          <Link
            href="#"
            target="_blank"
            className="absolute p-1 bg-[#d9edf9] rounded-full top-[130px] left-3 z-50"
          >
            <MediumIcon color="black" />
          </Link>
          <Link
            href="#"
            target="_blank"
            className="absolute p-1 bg-[#d9edf9] rounded-full top-[130px] right-4 z-50"
          >
